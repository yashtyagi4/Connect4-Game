 ...
 * Version:      12
 * Description:  The purpose of this version is to implement File Handling
 *               by printing as well as making a Leaderboard as a .txt and .bin
 *               File. This Version also implements readStat function that reads
 *               data of the file upto a particular game
*/
...
int main(int argc, char** argv) {  
    ...
    readStat(PData1,PData2,gameNo,PLAYER1,PLAYER2);
