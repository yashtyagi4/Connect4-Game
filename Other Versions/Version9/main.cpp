 ...
 * Version:      9
 * Description:  The purpose of this version is to implement the Player and
 *               Pstat class into the game (main.cpp)
 */
...
int main(int argc, char** argv) {  
    ...
    Pstat PLAYER2(players[static_cast<int>(P2)].getName() , 
          players[static_cast<int>(P2)].getID() ,'\0','\0','\0','\0',0);
    ...
    do { 
        ...
        if( connect(plyrptr[P] , board, brdrows, brdcols) ) {   
            ...
            gameNo++;                                  //Counting total number of games
