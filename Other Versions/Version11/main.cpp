 ...
 * Version:      11
 * Description:  The purpose of this version is to implement the FInfo Struct
 *               and make implement it to take data of the game.
*/
...
int main(int argc, char** argv) {  
    ...
    do { 
     ...
     if( static_cast<int>( brdFull(board, brdcols) ) == 7 ){
        ...
        drawIN(PLAYER1,PLAYER2,plyrs,PData1,PData2,stats,gameNo);
     }
    }while(again);
...
void drawIN(Pstat &PLAYER1,Pstat &PLAYER2,FInfo plyrs[],Data &PData1, Data &PData2
    ...
    PData1.fillTDraw(PData1,PLAYER1);
    PData2.fillTDraw(PData2,PLAYER2);
}
...
void movesIN(int P,Pstat &PLAYER1,Pstat &PLAYER2,FInfo plyrs[],Data &PData1, Data &PData2
    ...
    stats[P][3]++;
    if(P == 0)
         PLAYER1.setMove(gameNo,stats[P][3]);
    else PLAYER2.setMove(gameNo,stats[P][3]);
