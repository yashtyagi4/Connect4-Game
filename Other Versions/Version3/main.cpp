/* 
 * Author: Yash Tyagi
 * Created on October 11th, 2020, 7:33 PM
 * Purpose: Connect4 Game
 * Version: 3
 * Description: This version focuses on using file handling 
 * to create the leader board both as a text file and as a binary file
 */
...
char   brdFull(char [][7], const int);                                  //Check if board is full
                                                                        //upto any game
void   lrdrbrd(fstream &, fstream &, PInfo [], int, const int, char []);//To save the leaderboard in files
void   showLB(fstream &);                                               //To print the leaderboard
